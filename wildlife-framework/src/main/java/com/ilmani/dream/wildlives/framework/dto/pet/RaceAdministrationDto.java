...
public class RaceAdministrationDto extends RaceBusinessDto implements Serializable{

	private static final long serialVersionUID = -2024163533028655253L;

	private boolean isActive;

	public RaceAdministrationDto() {

	}
	
	public RaceAdministrationDto(String code) {
		this.code = code;
	}

	public RaceAdministrationDto(String name, String specie, String clan) {
		this.name = name;
		this.specie = specie;
		this.clan = clan;
	}

	public RaceAdministrationDto(String name, String scientistName, String code, String specie, String clan, boolean isActive) {
		this.name = name;
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof RaceAdministrationDto)) {
			return false;
		}
		RaceAdministrationDto other = (RaceAdministrationDto) obj;
		if (clan == null) {
			if (other.clan != null) {
				return false;
			}
