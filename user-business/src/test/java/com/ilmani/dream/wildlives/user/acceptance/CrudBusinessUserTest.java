...
public class CrudBusinessUserTest {
	...
	public void insertionOfNewUserIsPossible() throws Exception {
		UserDto userToSave = new UserInscriptionDto("pseudonym", "email@email.fr", "Passw$ord1", "Passw$ord1", "France",
				"78210", "Paris");
	...
	public void testGenerateExceptionBecausePaswordAndConfirmationNotSame() throws Exception {
		UserDto userToSave = new UserInscriptionDto("pseudonym", "email@email", "Passwor$d1", "Pas*sword2", "France",
				"78210", "Paris");
		userMngr.saveUser(userToSave);
	}
	...
	public void testGenerateExceptionBecausePasswordIsMalformed() throws Exception {
		UserDto userToSave = new UserInscriptionDto("pseudonym", "email@email", "password1", "password", "France",
				"78210", "Paris");
		userMngr.saveUser(userToSave);
	}
	...
	public void testGenerateExceptionBecauseEmailIsMalformed() throws Exception {
		UserDto userToSave = new UserInscriptionDto("pseudonym", "email@email.f.", "Pass!word1", "Pass!word1", "France",
				"78210", "Paris");
		userMngr.saveUser(userToSave);
	}
