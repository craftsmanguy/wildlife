...
import com.ilmani.dream.wildlives.presenter.rest.business.user.v1.resources.UserBusinessProvider;

@Singleton
@Path("/v1")
public class UserBusinessService extends AbstractService {
	...
	public Response findProfilByIdentifier(@PathParam("id") String pseudonym) throws Exception {
		return responseHeader.responseBuilder(HttpMethod.POST, Response.Status.OK)
